...
<body>
  <div class="container">
    ...
    <main>
      <div class="header">
        <h1 id="main-title">BMMS - Salaries Report</h1>
      </div>
      ...
      <div class="report-box">
        ...
        $where = "WHERE 1=1";
        if (!empty($startDate)) {
          $where .= " AND S.PaymentDate >= '$startDate 00:00:00'";
        }
        if (!empty($endDate)) {
          $where .= " AND S.PaymentDate <= '$endDate 23:59:59'";
        }

        $sql = "
          SELECT S.SalaryID, E.EmployeeName, S.Amount, S.AdvanceSalary, S.NetSalary, S.PaymentDate, S.PaymentMethod
          FROM Salaries S
        ...
        <table id="salariesTable" class="display nowrap inventory-table">
          <thead>
            <tr>
              <th>ID</th>
              <th>Employee</th>
